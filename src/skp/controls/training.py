...
#         if cfg.data.single_line == 'ett':
#             weights['linear.weight'] = weights['linear.weight'][:3]
#             weights['linear.bias'] = weights['linear.bias'][:3]
#         elif cfg.data.single_line == 'ngt':
#             weights['linear.weight'] = weights['linear.weight'][3:7]
#             weights['linear.bias'] = weights['linear.bias'][3:7]
#         elif cfg.data.single_line == 'cvc':
#             weights['linear.weight'] = weights['linear.weight'][7:10]
#             weights['linear.bias'] = weights['linear.bias'][7:10]            
